...
public class SwiftBlobStoreInfo extends BlobStoreInfo {
    ...
    public BlobStore createInstance(TileLayerDispatcher layers, LockProvider lockProvider)
        ...
        checkState(
                isEnabled(),
                "Can't call SwiftBlobStoreConfig.createInstance() is blob store is not enabled");
    ...
    public SwiftApi buildApi() {
        ...
        overrides.put(
                KeystoneProperties.PROJECT_DOMAIN_NAME,
                jcloudsKeystoneDomainName); // Since jclouds > v2.1.0 (see PROJECT_DOMAIN_ID as
        // complement)
