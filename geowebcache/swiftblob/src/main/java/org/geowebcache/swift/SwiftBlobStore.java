...
public class SwiftBlobStore implements BlobStore {
    ...
    public void put(TileObject obj) throws StorageException {
        ...
        log.trace(log.isTraceEnabled() ? ("Storing " + obj.getLayerName()) : "");

        // Upload the payload to object storage
        try {
            payload = newInputStreamPayload(blob.getInputStream());
            ...
            System.out.println("Error getting payload.");
    ...
    public boolean delete(String layerName) throws StorageException {
        ...
        checkNotNull(
                layerName,
                "layerName"); // This is the thing that throws the storage exception I think....
    ...
    public boolean rename(String oldLayerName, String newLayerName) throws StorageException {
        // TODO: Not sure if this needs renaming or not.... implement this
     ...
     * @param key the key of the metadata value to get
    ...
    public void putLayerMetadata(String layerName, String key, String value) {
        ...
        // Do something if the layer is null - maybe raise storage exception since layer not found
        // but then method signature needs to be updated....
        // Another option here is possibly use java optionals which would stop the null return
        // maybe.
        if (layer == null) {
            // Not sure if this is best practice since this is a void method.
            return;
        }
